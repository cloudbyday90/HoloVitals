/**
 * athenahealth Enhanced Sync API Endpoint
 * 
 * POST /api/ehr/athenahealth/enhanced-sync - Sync with enhanced features
 */
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.error('Error performing athenahealth enhanced sync:', error);
    return NextResponse.json(
