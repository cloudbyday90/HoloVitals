...
# HoloVitals v1.4.11 One-Line Installer
# Installation: wget https://raw.githubusercontent.com/cloudbyday90/HoloVitals/main/scripts/install-v1.4.11.sh && chmod +x install-v1.4.11.sh && ./install-v1.4.11.sh
...
echo "Feature Release - Service Configuration Flexibility"
echo "=================================================="
echo ""
...
echo "   - Access admin console: https://${DOMAIN_NAME}/admin"
echo "   - Go to Settings > External Services"
echo "   - Add API keys for services you want to enable"
echo "   - Services work independently - enable only what you need"
echo ""
echo "=================================================="
