...
import { STRIPE_CONFIG, SUBSCRIPTION_PLANS, getPlanById, isStripeConfigured } from '@/lib/config/stripe';
import {
  Subscription,
  PaymentMethod,
  Invoice,
...
export class StripePaymentService {
  ...
  async createPaymentIntent(
    ...
    this.ensureStripeConfigured(); clientSecret: string; paymentIntentId: string }> {
