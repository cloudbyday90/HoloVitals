  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-700 dark:text-gray-300">Here's what's happening with your medical analysis platform today.</p>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-gray-900 dark:text-gray-100">{stats.conversations}</div>
            <p className="text-xs text-gray-700 mt-1">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-gray-900 dark:text-gray-100">{stats.activeTasks}</div>
            <p className="text-xs text-gray-700 mt-1">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-gray-900 dark:text-gray-100">${stats.todayCost}</div>
            <p className="text-xs text-gray-700 mt-1">
      ...
      <Card className="bg-gradient-to-br from-green-50 to-emerald-50 border-green-200">
        ...
        <CardContent>
          <div className="grid md:grid-cols-2 gap-4">
            <div>
              <p className="text-sm text-gray-700 dark:text-gray-300 mb-1">Tokens Saved</p>
            ...
            <div>
              <p className="text-sm text-gray-700 dark:text-gray-300 mb-1">Cost Saved</p>
              <p className="text-3xl font-bold text-gray-900 dark:text-gray-100">
                ${stats.costSaved}
              </p>
        ...
        <CardContent>
          <div className="grid md:grid-cols-4 gap-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-gray-700 dark:text-gray-300">Chatbot Service</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-2 h-2 bg-green-500 rounded-full" />
              <span className="text-sm text-gray-700 dark:text-gray-300">Context Optimizer</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-2 h-2 bg-green-500 rounded-full" />
              <span className="text-sm text-gray-700 dark:text-gray-300">Analysis Queue</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-2 h-2 bg-green-500 rounded-full" />
              <span className="text-sm text-gray-700 dark:text-gray-300">Instance Provisioner</span>
            </div>
          </div>
        </CardContent>
      </Card>
